...
package de.jackwhite20.japs.server.network.initialize;
...
public class ClusterPublisherChannelInitializer extends ChannelInitializer<Channel> {
    ...
    private JaPSServer.ClusterPublisher clusterPublisher;

    public ClusterPublisherChannelInitializer(JaPSServer.ClusterPublisher clusterPublisher) {
